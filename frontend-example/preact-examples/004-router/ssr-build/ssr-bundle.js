...
var header_Header = function Header() {
  return Object(preact_min["h"])(
    ...
    Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        match["Link"],
        { activeClassName: header_style_default.a.active, href: "/createUser" },
        "createUser"
      )
    )
  );
...
// CONCATENATED MODULE: ./routes/Users.js
...
var Users__ref = Object(preact_min["h"])(
  "h1",
  null,
  "users"
);
...
var Users__default = function (_Component) {
...
var User_host = "https://mock-server-yznxmkzmvo.now.sh" || "http://localhost:3000";
...
var User__default = function (_Component) {
  User__inherits(_default, _Component);

  function _default() {
    var _temp, _this, _ret;

    User__classCallCheck(this, _default);
  ...
  _default.prototype.componentDidMount = function componentDidMount() {
    return new Promise(function ($return, $error) {
      var response, result;
      return Promise.resolve(fetch(User_host + "/users/" + this.props.userId)).then(function ($await_1) {
        try {
          response = $await_1;
          if (!response.ok) {
            return $return(alert("削除に失敗しました"));
        ...
        Object(preact_min["h"])(
          ...
          Object(preact_min["h"])(
            ...
            Object(preact_min["h"])(
              "td",
              null,
              this.state.user.genderCode == "1" ? "男性" : "女性"
            )
          )
        )
      )
...
// CONCATENATED MODULE: ./routes/CreateUser.js
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };



function CreateUser__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function CreateUser__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function CreateUser__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }




var CreateUser_host = "https://mock-server-yznxmkzmvo.now.sh" || "http://localhost:3000";

var CreateUser__ref = Object(preact_min["h"])(
  "h1",
  null,
  "form"
);

var CreateUser__ref2 = Object(preact_min["h"])("br", null);

var _ref3 = Object(preact_min["h"])("br", null);

var _ref4 = Object(preact_min["h"])("br", null);

var CreateUser__default = function (_Component) {
  CreateUser__inherits(_default, _Component);

  function _default() {
    var _temp, _this, _ret;

    CreateUser__classCallCheck(this, _default);
    ...
    return _ret = (_temp = (_this = CreateUser__possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.state = {
      ...
      return new Promise(function ($return, $error) {
        var response, result;
        return Promise.resolve(fetch(CreateUser_host + "/users", {
          method: "POST",
          headers: {
            "Content-Type": "application/json"
          },
          ...
          try {
            ...
            return Promise.resolve(response.json()).then(function ($await_2) {
              try {
                ...
                Object(preact_router_es["route"])("users/" + result.id, true);
                return $return();
              } catch ($boundEx) {
                return $error($boundEx);
              }
    ...
    }, _temp), CreateUser__possibleConstructorReturn(_this, _ret);
  }
...
var app__ref2 = Object(preact_min["h"])(Users__default, { path: "/" });

var app__ref3 = Object(preact_min["h"])(User__default, { path: "/users/:userId" });

var app__ref4 = Object(preact_min["h"])(CreateUser__default, { path: "/createUser" });
